                        ...
                        <div class="cart"> 
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                <div class="cart-item" id="cart-item{{$product['item']['id']}}">
                                    <a class="cart-item-delete" value="{{$product['item']['id']}}" soluong="{{$product['qty']}}"><i class="fa fa-time"></i></a>
                                    <div class="media">
                                        <a class="pull-left" href="#"><img src="/sources/image/product/{{$product['item']['image']}}" alt=""></a>
                                        <div class="media-body">
                                            <span class="cart-item-title">{{$product['item']['name']}}</span>
                                            <span class="cart-item-options">{{$product['item']['qty']}}*<span>{{$product['item']['unit_price']}}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
